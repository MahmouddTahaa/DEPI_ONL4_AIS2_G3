...
# Add new student
def add_student_1(manager: SystemManager) -> None:
...
def record_grade(manager: SystemManager) -> None:
...
def get_all_students(manager: SystemManager) -> None:
...
def get_all_courses(manager: SystemManager) -> None:
...
def enroll_course(manager: SystemManager) -> None:
    student_id = int(input("Enter student ID: "))
    course_id = int(input("Enter course ID: "))
